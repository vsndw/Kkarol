        ...
        <div className="flex flex-col items-center gap-4 text-center md:items-end md:text-right">
          ...
          <div className="flex flex-col items-center md:items-end gap-1.5 mt-1 border-t border-border/20 pt-3 md:border-none md:pt-0">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-3 gap-y-1 text-xs">
              <a href="https://github.com/parthakashyap" className="hover:text-primary transition-colors">GitHub</a>
              <a href="https://linkedin.com/in/partha-pratim-kashyap" className="hover:text-primary transition-colors">LinkedIn</a>
              <a href="https://instagram.com/partha_kashyap__" className="hover:text-primary transition-colors">Instagram</a>
              <a href="mailto:parthakashyal@gmail.com" className="hover:text-primary transition-colors">Email</a>
            </div>
          </div>
        </div>
      </div>
